...
# total data bytes
	...
	for file in files:
		...
		print 'Wrote {0} bytes of data for file {1} at offset {2}, real path {3} mode {4}'.format(file.length, file.name, file.offset, file.path, file.mode)
